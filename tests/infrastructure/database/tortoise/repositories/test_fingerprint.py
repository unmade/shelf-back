...
from app.infrastructure.database.tortoise.repositories.fingerprint import (
    _join_int2,
    _split_int8_by_int2,
)
...
if TYPE_CHECKING:
    ...
    from app.infrastructure.database.tortoise.repositories import FingerprintRepository
...
async def _get_by_file_id(file_id: UUID) -> models.Fingerprint:
    return await models.Fingerprint.get(file_id=file_id)
