...
from app.infrastructure.database.gel.repositories.file_pending_deletion import (
    FilePendingDeletionRepository,
)
from app.toolkit.mediatypes import MediaType

if TYPE_CHECKING:
    from tests.infrastructure.database.gel.conftest import FilePendingDeletionFactory
