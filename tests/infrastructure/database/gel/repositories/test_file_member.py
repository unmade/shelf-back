...
from app.infrastructure.database.gel.repositories.file_member import ActionFlag

if TYPE_CHECKING:
    from uuid import UUID

    from app.app.files.domain.file_member import FileMemberActions
    from app.infrastructure.database.gel.repositories import FileMemberRepository
